...
import com.example.animewifuapplication.utils.getRandomCategory
...
internal class StackRemoteViewFactory @Inject constructor(@ApplicationContext private val context: Context,private val animeRepository: AnimeRepository) :
    ...
    override fun onDataSetChanged() {
        ...
        runBlocking {
            ...
            animeRepository.getWaifuPics("sfw",category.toString())
            Log.d("checkingFinalApi_",category)
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        val extras = bundleOf(WaifuBannerWidget.EXTRA_ITEM to position)
    ...
    private suspend fun getBitmapFromUrl(url: String): Bitmap? {
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                Log.e("StackRemoteViewFactory", "Error loading image: $url", e)
                e.printStackTrace()
                null
            }
        }
